...
box{color = 80,0,0;height= 5;width = 5;}box80;		#5		SC trial GO onset: left  middle
box{color = 96,0,0;height= 5;width = 5;}box96;		#6		SC trial GO onset: left  index
box{color = 112,0,0;height= 5;width = 5;}box112;	#7		SC trial GO onset: right index
box{color = 128,0,0;height= 5;width = 5;}box128;	#8		SC trial GO onset: right middle
box{color = 144,0,0;height= 5;width = 5;}box144;	#9		SC trial STOP onset: left  middle to right middle box144
box{color = 160,0,0;height= 5;width = 5;}box160;	#10	SC trial STOP onset: left  index  to right index
box{color = 176,0,0;height= 5;width = 5;}box176;	#11	SC trial STOP onset: right middle to right index
box{color = 192,0,0;height= 5;width = 5;}box192;	#12	SC trial STOP onset: right index  to right middle 
box{color = 208,0,0;height= 5;width = 5;}box208;	#13
box{color = 224,0,0;height= 5;width = 5;}box224;	#14
box{color = 240,0,0;height= 5;width = 5;}box240;	#15
...
#block
array {
   text { caption = "1/12ブロック目"; font_size=36; } block1;
   text { caption = "2/12ブロック目"; font_size=36; } block2;
   text { caption = "3/12ブロック目"; font_size=36; } block3;
   text { caption = "4/12ブロック目"; font_size=36; } block4;
   text { caption = "5/12ブロック目"; font_size=36; } block5;
	text { caption = "6/12ブロック目"; font_size=36; } block6;
   text { caption = "7/12ブロック目"; font_size=36; } block7;
   text { caption = "8/12ブロック目"; font_size=36; } block8;
   text { caption = "9/12ブロック目"; font_size=36; } block9;
   text { caption = "10/12ブロック目"; font_size=36; } block10;
	text { caption = "11/12ブロック目"; font_size=36; } block11;
	text { caption = "12/12ブロック目"; font_size=36; } block12;
} block_letters;

array {
   text { caption = "1/12ブロック目終了"; font_size=36; } block1_t;
   text { caption = "2/12ブロック目終了"; font_size=36; } block2_t;
   text { caption = "3/12ブロック目終了"; font_size=36; } block3_t;
   text { caption = "4/12ブロック目終了"; font_size=36; } block4_t;
   text { caption = "5/12ブロック目終了"; font_size=36; } block5_t;
	text { caption = "6/12ブロック目終了"; font_size=36; } block6_t;
   text { caption = "7/12ブロック目終了"; font_size=36; } block7_t;
   text { caption = "8/12ブロック目終了"; font_size=36; } block8_t;
   text { caption = "9/12ブロック目終了"; font_size=36; } block9_t;
   text { caption = "10/12ブロック目終了"; font_size=36; } block10_t;
	text { caption = "11/12ブロック目終了"; font_size=36; } block11_t;
	text { caption = "12/12ブロック目終了"; font_size=36; } block12_t;
} block_tale_letters;
...
$change_trial_duration 	= 500;
$change_stim_duration 	= 480;
$block_count = 1;
#---------------------------------------------------------------------- INSTRUCTION
#---------------------------------------------------------------------- BLOCK HEAD
trial{
...
trial{
	...
	stimulus_event{
		picture{
			text{caption="$block_countブロック終了"; font_size=36;}text_block_tale;
			x=0; y=0;
...
trial{
	...
	stimulus_event {
			...
			picture{
				#trigger
				box box16; #event.present()直前で差し替える　※LRどちらのGOも受けるため
				x =$trigger_x; y =$trigger_y ;
				#stim
				text{caption="+"; font_size=48;};
				x=0; y=0;
		...
		duration=$trigger_duration;
		#enable response
		target_button = 4;									#target button:right middle
		stimulus_time_in 	= 0;  							# assign response that occur
		stimulus_time_out = $trigger_duration; 	# 0-1000 ms after the stimulus
		code = "SC trial CHANGE stim right middle";
	}event_chg_r_mid_t;
	...
	#			x=$target4x; y=$target4y;
	#		}pic_chg_r_mid_after;
	#	time=$chg_after_stim_onset;
	#	duration=$chg_after_stim_duration;
...
trial{
	...
	stimulus_event {
		...
		duration=$trigger_duration;
		#enable response
		target_button = 3;									#target button:right index
		stimulus_time_in 	= 0;  							# assign response that occur
		stimulus_time_out = $trigger_duration; 	# 0-1000 ms after the stimulus
		code = "SC trial CHANGE stim right idx";
	}event_chg_r_idx_t;
	...
	stimulus_event{
		...
		delta_time = 20;#$trigger_duration;
		duration=$change_stim_duration;
		target_button = 3;									#target stim:right index
		stimulus_time_in = $change_stim_onset;
		stimulus_time_out = $change_stim_duration;
	}event_chg_r_idx;
...
#array<int>select_jitter[max_trial];
int fix_jitter;

#SSD
int initial_ssd = 140;
int finger_ssd = initial_ssd;
int hand_ssd = initial_ssd;
int min_ssd = 20;
int max_ssd = 500;
int ssd_adjuster = 20;
...
loop int i=1 until i>max_trial/8 begin
	...
	select_trial.add(5); #5:sc_lm_rm;
	select_trial.add(6); #6:sc_li_ri;
	select_trial.add(7); #7:sc_rm_ri;
	select_trial.add(8); #8:sc_ri_rm;
	i=i+1;
end;
...
begin
   ...
   begin
		...
		if seq[i] ==5 || seq[i]==6 then
			buff=5;
		elseif seq[i]==7 || seq[i]==8 then
			buff=6;	
		else
			buff=seq[i];
		end;
...
loop int j=1 until j>select_trial.count() begin
	...
	elseif(select_trial[j]==5)then#--------------------------------------------------------------------------------5:sc_lm_rm;
		#set latest SSD
		trial_stop_l_mid.set_duration(hand_ssd);
		#set trigger
		...
		if stop.type() == stimulus_false_alarm then
			feedback_pic.set_part(1, f_a);		#debug feedback
			feedback_trial.present();				#debug feedback
			event_t_error_inhibit.set_event_code("inhibition error hc ssd" + string(hand_ssd));
			trial_t_error_inhibit.present();
			if hand_ssd <= min_ssd then		#SSD modulation
				hand_ssd = min_ssd;
			else
			hand_ssd = hand_ssd-ssd_adjuster;
			end;
		elseif stop.type() == stimulus_other then
			#set trigger
			pic_chg_r_mid_t.set_part(1,box144);	#9		SC trial STOP onset: left  middle to right middle box144
			sound_event_chg_r_mid.set_event_code("hc ssd " + string(hand_ssd));
			#change trial start
			trial_chg_r_mid.present();
			stimulus_data chg = stimulus_manager.last_stimulus_data();
			if chg.type() == stimulus_hit then
				feedback_pic.set_part(1, good);		#debug feedback
				feedback_trial.present();				#debug feedback
				trial_t_correct.present();
				if hand_ssd >= max_ssd then			#SSD modulation
					hand_ssd = max_ssd;
				else
					hand_ssd = hand_ssd+ssd_adjuster;
				end;
			elseif chg.type() == stimulus_incorrect then
			...
			elseif chg.type() == stimulus_miss then
					feedback_pic.set_part(1, missed);	#debug feedback
					event_feedback.set_event_code("omission");
					feedback_trial.present();				#debug feedback
					if hand_ssd <= min_ssd then			#SSD modulation
	...
	elseif(select_trial[j]==6)then#--------------------------------------------------------------------------------6:sc_li_ri;
		#set latest SSD
		trial_stop_l_idx.set_duration(hand_ssd);
		#set trigger
		...
		elseif stop.type() == stimulus_other then
			#set trigger
			pic_chg_r_idx_t.set_part(1,box160);		#10	SC trial STOP onset: left  index  to right index box160;
			sound_event_chg_r_idx.set_event_code("hc ssd " + string(hand_ssd));
			#change trial start
			trial_chg_r_idx.present();
			stimulus_data chg = stimulus_manager.last_stimulus_data();
			if chg.type() == stimulus_hit then
				feedback_pic.set_part(1, good);		#debug feedback
				feedback_trial.present();				#debug feedback
		...
		elseif(select_trial[j]==7)then#--------------------------------------------------------------------------------#7:sc_rm_ri;
		#set latest SSD
		trial_stop_r_mid.set_duration(finger_ssd);
		#set trigger
		...
		if stop.type() == stimulus_false_alarm then
			feedback_pic.set_part(1, f_a);		#debug feedback
			feedback_trial.present();			#debug feedback
			event_t_error_inhibit.set_event_code("inhibition error fc ssd" + string(finger_ssd));
			trial_t_error_inhibit.present();
			if finger_ssd <= min_ssd then		#SSD modulation
				finger_ssd = min_ssd;
			else
				finger_ssd = finger_ssd-ssd_adjuster;
			end;
		elseif stop.type() == stimulus_other then
			#set trigger
			pic_chg_r_idx_t.set_part(1,box176);		#11	SC trial STOP onset: right middle to right index box176;
			sound_event_chg_r_idx.set_event_code("fc ssd " + string(finger_ssd));
			#change trial start
			trial_chg_r_idx.present();
			stimulus_data chg = stimulus_manager.last_stimulus_data();
			if chg.type() == stimulus_hit then
				...
				feedback_trial.present();				#debug feedback
				trial_t_correct.present();
				if finger_ssd >= max_ssd then				#SSD modulation
					finger_ssd = max_ssd;
				else
					finger_ssd = finger_ssd+ssd_adjuster;
				end;
	...
	#elseif
		elseif(select_trial[j]==8)then#--------------------------------------------------------------------------------#8:sc_ri_rm;
		#set latest SSD
		trial_stop_r_idx.set_duration(finger_ssd);
		#set trigger
		#pic_stop_l_idx_t.set_part(1,box96);		#8		SC trial GO onset: right middle	
		#stop trial start
		#event_fix.set_event_code("fix " + string(j));
		...
		elseif stop.type() == stimulus_other then
			#set trigger
			pic_chg_r_mid_t.set_part(1,box192);		#12	SC trial STOP onset: right index  to right middle box192
			sound_event_chg_r_mid.set_event_code("fc ssd " + string(finger_ssd));
			#change trial start
			trial_chg_r_mid.present();
			stimulus_data chg = stimulus_manager.last_stimulus_data();
			if chg.type() == stimulus_hit then
