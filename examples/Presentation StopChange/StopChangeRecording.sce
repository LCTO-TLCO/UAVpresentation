...
#loop int jitter=1 until jitter>max_trial/3 begin
#	select_jitter.add(500);	#500 ms;
#	select_jitter.add(600);	#600 ms;
#	select_jitter.add(700); #700 ms;
#	jitter=jitter+1;
#end;

#1 block分のfixation jitterを作る
